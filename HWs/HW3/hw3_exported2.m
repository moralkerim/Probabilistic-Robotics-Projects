classdef hw3_exported2 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            ...
            %   app.sign1.Mx = 1; app.sign1.My = -1;
            %  app.sign2.Mx = 2; app.sign2.My = 5;
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ExecuteButton.Position = [58 10 100 22];
            ...
            app.LandmarkPanel.Position = [574 287 215 156];
